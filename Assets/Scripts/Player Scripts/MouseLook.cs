...
public class MouseLook : MonoBehaviour
{
    ...
    [SerializeField] private float smooth_weight = .4f;
    [SerializeField] private float roll_Angle = 10f;
    [SerializeField] private float roll_Speed = 3f;
    [SerializeField] private Vector2 default_Look_Limits = new Vector2(-70f, 80);
    ...
    void LookAround() {
        // in vector2 we use (y,x) because of when we move our mouse we see in rotation y axis is rotate left ans right and x axis shown us up and down
